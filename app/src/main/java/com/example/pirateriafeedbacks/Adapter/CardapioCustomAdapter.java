...
public class CardapioCustomAdapter extends RecyclerView.Adapter<CardapioCustomAdapter.CustomViewHolder> {

    private List<Cardapio> dataList;
    private Context context;

    public CardapioCustomAdapter(Context context, List<Cardapio> dataList){
    ...
    public void onBindViewHolder(CustomViewHolder holder, int position) {
        ...
        builder.build().load(dataList.get(position).getDescricaoCardapio())
