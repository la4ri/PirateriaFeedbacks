package com.example.pirateriafeedbacks.SecondaryPages;
...
// Configurar RecyclerView
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(VisualizarFeedbackActivity.this);
        ...
        call.enqueue(new Callback<List<Feedback>>() {
            ...
            public void onResponse(Call<List<Feedback>> call, Response<List<Feedback>> response) {
                if (response.isSuccessful()) {
                    ...
                    Toast.makeText(VisualizarFeedbackActivity.this, "Erro ao obter dados", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<List<Feedback>> call, Throwable t) {
                Toast.makeText(VisualizarFeedbackActivity.this, "Erro de conexão", Toast.LENGTH_SHORT).show();
            }
        });
    }
